...
export async function generateMetadata({
  ...
  return {
    title: t("metadata.title", { step: t("steps.6.title") }),
    description: t("metadata.description"),
  };
}

function Step6() {
  const t = useTranslations("GuideOnboardingPage.steps.6");
...
export default withRole(Step6, PREDEFINED_ROLES.GUIDE_ONLY, {
  redirectInsufficientRoleTo: "/dashboard",
  redirectUnauthenticatedTo: createRedirectUrl("/guide/onboarding/step-6"),
});